...
2) **Bernoulli Sequence**: Any sequence of M independent subexperiments with each subexperiment producing two possible outcomes is called a Bernoulli sequence.
